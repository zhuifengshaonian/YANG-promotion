...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "ietf-inet-types";
    private final String namespace = "urn:ietf:params:xml:ns:yang:ietf-inet-types";
    private final String revision = "2010-09-24";
    private final String resourcePath = "/META-INF/yang/ietf-inet-types.yang";
