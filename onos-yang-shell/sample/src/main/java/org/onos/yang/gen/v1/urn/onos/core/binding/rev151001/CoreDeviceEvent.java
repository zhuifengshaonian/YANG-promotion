 ...
 * &lt;i&gt;core-binding/core-device-event&lt;/i&gt;
 *
 */
public abstract class CoreDeviceEvent extends ServiceType implements Notify
 {
    public static final QName QNAME = org.onos.yangtools.yang.common.QName.cachedReference(org.onos.yangtools.yang.common.QName.create("urn:onos:core:binding","2015-10-01","core-device-event"));


    public CoreDeviceEvent() {
