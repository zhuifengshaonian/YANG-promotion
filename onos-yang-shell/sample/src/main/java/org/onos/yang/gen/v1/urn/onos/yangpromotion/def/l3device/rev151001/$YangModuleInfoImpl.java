...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "l3-device";
    private final String namespace = "urn:onos:yangpromotion:def:l3device";
    private final String revision = "2015-10-01";
    private final String resourcePath = "/META-INF/yang/l3-device.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.onos.yang.gen.v1.urn.onos.yang.extension.yang.ext.rev130709.$YangModuleInfoImpl.getInstance());
        set.add(org.onos.yang.gen.v1.urn.onos.core.device.rev151001.$YangModuleInfoImpl.getInstance());
        set.add(org.onos.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev100924.$YangModuleInfoImpl.getInstance());
