 ...
 * &lt;i&gt;core-binding/core-device-service&lt;/i&gt;
 *
 */
public abstract class CoreDeviceService extends ServiceType implements Servize
 {
    public static final QName QNAME = org.onos.yangtools.yang.common.QName.cachedReference(org.onos.yangtools.yang.common.QName.create("urn:onos:core:binding","2015-10-01","core-device-service"));


    public CoreDeviceService() {
