...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "core-device";
    private final String namespace = "urn:onos:core:device";
    private final String revision = "2015-10-01";
    private final String resourcePath = "/META-INF/yang/core-device.yang";
