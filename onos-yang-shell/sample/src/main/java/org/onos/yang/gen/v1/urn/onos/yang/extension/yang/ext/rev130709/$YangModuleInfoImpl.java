...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "yang-ext";
    private final String namespace = "urn:onos:yang:extension:yang-ext";
    private final String revision = "2013-07-09";
    private final String resourcePath = "/META-INF/yang/yang-ext.yang";
