 ...
 * only one is allowed to exist at one time in particular context of parent node.
   YANG Model and
 * schema for choice is described by instance of  {@link org.onos.yangtools.yang.model.api.ChoiceNode}.
 * Valid alternatives of subtree are described by instances of {@link org.onos.yangtools.yang.model.api.ChoiceCaseNode}
 * which are retrieved via {@link org.onos.yangtools.yang.model.api.ChoiceNode#getCases()}.
 *
 */
