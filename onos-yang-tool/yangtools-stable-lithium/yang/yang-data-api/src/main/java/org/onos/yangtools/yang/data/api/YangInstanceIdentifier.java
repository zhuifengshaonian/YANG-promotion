 ...
 */
package org.onos.yangtools.yang.data.api;
...
import org.onos.yangtools.concepts.Path;
import org.onos.yangtools.util.HashCodeBuilder;
...
public abstract class YangInstanceIdentifier extends IterablePathArguments implements Path<YangInstanceIdentifier>, Immutable, Serializable {
    ...
    /**
     * Simple path argument identifying a {@link org.onos.yangtools.yang.data.api.schema.ContainerNode} or
     * {@link org.onos.yangtools.yang.data.api.schema.LeafNode} leaf in particular subtree.
     */
    ...
    /**
     * Composite path argument identifying a {@link org.onos.yangtools.yang.data.api.schema.MapEntryNode} leaf
     * overall data tree.
     */
    ...
    /**
     * Composite path argument identifying a {@link org.onos.yangtools.yang.data.api.schema.AugmentationNode} node in
     * particular subtree.
     *
