...
import org.onos.yangtools.util.MapAdaptor;
...
import org.onos.yangtools.yang.data.api.schema.OrderedNodeContainer;
...
abstract class ContainerNode extends AbstractTreeNode {
     ...
     * from all of the container child iterables stored in {@link org.onos.yangtools.yang.data.api.schema.NormalizedNodeContainer#getValue()}
     * <br>
     ...
     * from all of the container child iterables stored in {@link org.onos.yangtools.yang.data.api.schema.OrderedNodeContainer#getValue()}
     * <br>
     * The reason why is this method called recursively is that in background method calls {@link TreeNodeFactory#createTreeNodeRecursively}
     * for each child stored in NormalizedNode and after each child is created the method calls again {@link #createNormalizedNodeRecursively} method
     * until all of the children are resolved.
