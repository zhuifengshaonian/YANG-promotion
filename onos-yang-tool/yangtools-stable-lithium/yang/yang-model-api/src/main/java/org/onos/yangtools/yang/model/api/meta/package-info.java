 ...
 * <p>
 * Statements are represented as instances / subclasses of {@link org.onos.yangtools.yang.model.api.meta.ModelStatement}
 * concept and its two subconcepts which are:
 * <ul>
 * <li>
 * {@link org.onos.yangtools.yang.model.api.meta.DeclaredStatement} - this contains navigable
 * set of statements model as they was defined / present in original processed
 * sources.
 * </li>
 * <li>{@link org.onos.yangtools.yang.model.api.meta.EffectiveStatement} - navigable set of statements
 ...
 * <p>
 * Common abstraction for various types of namespaces is {@link org.onos.yangtools.yang.model.api.meta.IdentifierNamespace}
 * from which concrete effective model namespaces are derived.
 *
 */
package org.onos.yangtools.yang.model.api.meta;