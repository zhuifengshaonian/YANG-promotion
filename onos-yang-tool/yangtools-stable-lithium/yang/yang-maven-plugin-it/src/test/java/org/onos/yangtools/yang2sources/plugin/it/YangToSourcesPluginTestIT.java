 ...
 */
package org.onos.yangtools.yang2sources.plugin.it;
...
public class YangToSourcesPluginTestIT {
    ...
    public void testAdditionalConfiguration() throws Exception {
        ...
        v.verifyTextInLog("[DEBUG] yang-to-sources: Additional configuration picked up for : org.onos.yangtools.yang2sources.spi.CodeGeneratorTestImpl: {nm1=abcd=a.b.c.d, nm2=abcd2=a.b.c.d.2}");
        v.verifyTextInLog("[DEBUG] yang-to-sources: Additional configuration picked up for : org.onos.yangtools.yang2sources.spi.CodeGeneratorTestImpl: {c1=config}");
        ...
        v.verifyTextInLog(
                Joiner.on(File.separator).join(
                        ...
                        + " marked as resources for generator: org.onos.yangtools.yang2sources.spi.CodeGeneratorTestImpl");
    }
    ...
    public void testMissingYangInDep() throws Exception {
        try {
            ...
            assertVerificationException(
                    e,
                    "org.onos.yangtools.yang.parser.util.YangValidationException: Not existing module imported:unknownDep:2013-02-27 by:private:2013-02-27");
            return;
        }
    ...
    public void testNamingConflict() throws Exception {
        ...
        v.verifyTextInLog("[WARNING] Naming conflict for type 'org.onos.yang.gen.v1.urn.yang.test.rev140303.NetworkTopologyRef': file with same name already exists and will not be generated.");
    }
    ...
    static void verifyCorrectLog(final Verifier v) throws VerificationException {
        ...
        v.verifyTextInLog("[INFO] yang-to-sources: Code generator instantiated from org.onos.yangtools.yang2sources.spi.CodeGeneratorTestImpl");
        v.verifyTextInLog("[INFO] yang-to-sources: Sources generated by org.onos.yangtools.yang2sources.spi.CodeGeneratorTestImpl: null");
    }
