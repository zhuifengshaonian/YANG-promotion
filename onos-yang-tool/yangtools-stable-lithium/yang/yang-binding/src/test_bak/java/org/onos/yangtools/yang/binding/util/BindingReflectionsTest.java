...
public class BindingReflectionsTest {
    ...
    public void testBindingWithDummyObject() {
        assertEquals("Package name should be equal to string", "org.onos.yang.gen.v1.test.rev990939",
                BindingReflections.getModelRootPackageName("org.onos.yang.gen.v1.test.rev990939"));
