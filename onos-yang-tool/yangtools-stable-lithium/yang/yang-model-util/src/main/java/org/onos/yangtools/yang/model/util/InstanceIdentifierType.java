...
public final class InstanceIdentifierType implements InstanceIdentifierTypeDefinition, Immutable {
     ...
     *
     * @see
     * org.onos.yangtools.yang.model.api.TypeDefinition#getBaseType()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.TypeDefinition#getUnits()
     */
    @Override
     ...
     *
     * @see
     * org.onos.yangtools.yang.model.api.TypeDefinition#getDefaultValue
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.SchemaNode#getQName()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.SchemaNode#getPath()
     */
    @Override
     ...
     *
     * @see
     * org.onos.yangtools.yang.model.api.SchemaNode#getDescription()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.SchemaNode#getReference()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.SchemaNode#getStatus()
     */
    @Override
     ...
     *
     * @see
     * org.onos.yangtools.yang.model.api.SchemaNode#getExtensionSchemaNodes
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.onos.yangtools.yang.model.api.type.
