 ...
 *
 * @see org.onos.yangtools.yang.parser.builder.impl.RpcDefinitionBuilder
 *
...
public class RpcDefinitionBuilderTest extends AbstractBuilderTest {
    ...
    public void testBuild() {
        ...
        assertEquals(instance.toString(), "RpcDefinitionImpl[qname=(urn:onos.rpc:def:test-model?" +
            "revision=2014-01-06)send-message, path=AbsoluteSchemaPath{path=[(urn:onos.rpc:def:test-model?" +
