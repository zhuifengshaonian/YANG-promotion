 ...
 *
 * @see org.onos.yangtools.yang.parser.builder.impl.BuilderUtils
 *
 * @author Lukas Sedlak <lsedlak@cisco.com>
 */
public class BuilderUtilsTest {

    private final static String MASTER_MODULE_NAMESPACE = "urn:onos.master-model";
    private final static String MODULES_REVISION = "2014-10-06";
    private final static String MASTER_MODULE = "master-module";
    private final static String DEPENDENT_MODULE_NAMESPACE = "urn:onos.secondary-model";
    ...
    private Map<String, NavigableMap<Date, ModuleBuilder>> initModuleBuildersForTest() throws Exception {
        ...
        module3.setNamespace(URI.create("urn:onos.ternary-model"));
