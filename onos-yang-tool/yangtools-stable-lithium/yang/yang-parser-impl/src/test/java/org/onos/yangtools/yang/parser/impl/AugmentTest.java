...
public class AugmentTest {
    private static final URI fooNS = URI.create("urn:onos.foo");
    private static final URI barNS = URI.create("urn:onos.bar");
    private static final URI bazNS = URI.create("urn:onos.baz");
    ...
    public void testAugmentRpc() throws Exception {
        ...
        final URI NS_BAR = URI.create("urn:onos:bar");
        final URI NS_FOO = URI.create("urn:onos:foo");
