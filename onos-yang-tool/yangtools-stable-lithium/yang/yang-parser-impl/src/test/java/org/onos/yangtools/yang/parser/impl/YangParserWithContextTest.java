...
public class YangParserWithContextTest {
    ...
    public void testUsesFromContext() throws Exception {
        ...
        // get grouping
        Module contextModule = context.findModuleByNamespace(URI.create("urn:onos.baz")).iterator().next();
    ...
    public void testUsesRefineFromContext() throws Exception {
        ...
        QName qname = QName.create(URI.create("urn:onos.baz"), simpleDateFormat.parse("2013-02-27"), "target");
        path.add(qname);
    ...
    public void testDeviation() throws Exception {
        ...
        URI expectedNS = URI.create("urn:onos.bar");
