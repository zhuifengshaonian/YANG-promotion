...
public class UsesAugmentTest {
    private static final URI UG_NS = URI.create("urn:onos:params:xml:ns:yang:uses-grouping");
    private static final URI GD_NS = URI.create("urn:onos:params:xml:ns:yang:grouping-definitions");
    private Date UG_REV;
    private Date GD_REV;
