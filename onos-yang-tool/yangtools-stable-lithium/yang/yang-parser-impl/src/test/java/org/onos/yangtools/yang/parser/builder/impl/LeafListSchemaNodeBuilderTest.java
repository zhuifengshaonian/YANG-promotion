 ...
 *
 * @see org.onos.yangtools.yang.parser.builder.impl.LeafListSchemaNodeBuilder
 *
...
public class LeafListSchemaNodeBuilderTest extends AbstractBuilderTest {
    ...
    public void testLeafListSchemaNodeImplProperties() {
        ...
        assertEquals("LeafListSchemaNodeImpl[(urn:onos.rpc:def:test-model?revision=2014-01-06)base-leaf-list]",
            leafList.toString());
    }
}
