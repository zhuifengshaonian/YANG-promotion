...
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.checkMissingBody;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.createListKey;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.getConfig;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.getIdentityrefBase;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseConstraints;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseDefault;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseRefine;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseSchemaNodeArgs;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseStatus;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseTypeWithBody;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseUnits;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseUserOrdered;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.parseYinValue;
import static org.onos.yangtools.yang.parser.impl.ParserListenerUtils.stringFromNode;
...
import org.onos.yangtools.antlrv4.code.gen.YangParser.Contact_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Container_stmtContext;
...
import org.onos.yangtools.antlrv4.code.gen.YangParser.Deviate_add_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Deviate_delete_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Deviate_not_supported_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Deviate_replace_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Import_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Key_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Leaf_list_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Leaf_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.List_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Module_header_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Namespace_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Ordered_by_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Organization_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Prefix_stmtContext;
...
import org.onos.yangtools.antlrv4.code.gen.YangParser.Revision_date_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Revision_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Revision_stmtsContext;
...
import org.onos.yangtools.antlrv4.code.gen.YangParser.Yang_version_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParserBaseListener;
...
import org.onos.yangtools.yang.parser.builder.api.ExtensionBuilder;
import org.onos.yangtools.yang.parser.builder.api.GroupingBuilder;
...
import org.onos.yangtools.yang.parser.builder.api.UsesNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.AnyXmlBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ChoiceBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ChoiceCaseBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ContainerSchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.CopyUtils;
import org.onos.yangtools.yang.parser.builder.impl.DeviationBuilder;
import org.onos.yangtools.yang.parser.builder.impl.FeatureBuilder;
import org.onos.yangtools.yang.parser.builder.impl.IdentitySchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.LeafListSchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.LeafSchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ListSchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ModuleBuilder;
import org.onos.yangtools.yang.parser.builder.impl.NotificationBuilder;
import org.onos.yangtools.yang.parser.builder.impl.RefineHolderImpl;
import org.onos.yangtools.yang.parser.builder.impl.RpcDefinitionBuilder;
import org.onos.yangtools.yang.parser.builder.impl.UnionTypeBuilder;
import org.onos.yangtools.yang.parser.builder.impl.UnknownSchemaNodeBuilderImpl;
...
public final class YangParserListenerImpl extends YangParserBaseListener {
    ...
    private void handleUnknownNode(final int line, final ParseTree ctx) {
        ...
        try {
            ...
            // https://bugs.onos.org/show_bug.cgi?id=1539
            // After this fix bug
            // https://bugs.onos.org/show_bug.cgi?id=1538 MUST be fixed
            // since
            // they are dependent!!!
