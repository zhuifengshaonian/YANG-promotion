...
public final class ConstraintsBuilderImpl implements ConstraintsBuilder {
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#build()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getModuleName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getLine()
     */
    @Override
    public int getLine() {
        return line;
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getMinElements()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#setMinElements(java.lang.Integer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getMaxElements()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#setMaxElements(java.lang.Integer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getMustDefinitions()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#addMustDefinition(org.onos.yangtools.yang.model.api.MustDefinition)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#getWhenCondition()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#addWhenCondition(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#isMandatory()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IConstraintsBuilder#setMandatory(boolean)
     */
    @Override
