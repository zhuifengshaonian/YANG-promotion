...
import org.onos.yangtools.antlrv4.code.gen.YangParser;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Argument_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Base_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Bit_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Bits_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Config_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Config_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Decimal64_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Default_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Description_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Enum_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Enum_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Error_app_tag_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Error_message_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Fraction_digits_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Identityref_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Instance_identifier_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Key_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Leafref_specificationContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Length_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Mandatory_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Mandatory_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Max_elements_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Max_value_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Min_elements_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Min_value_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Module_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Must_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Numerical_restrictionsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Ordered_by_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Ordered_by_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Path_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Pattern_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Position_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Presence_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Range_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Reference_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_anyxml_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_choice_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_container_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_leaf_list_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_leaf_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_list_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_pomContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Refine_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Require_instance_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Require_instance_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Status_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Status_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.StringContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.String_restrictionsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Type_body_stmtsContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Units_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Value_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.When_stmtContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Yin_element_argContext;
import org.onos.yangtools.antlrv4.code.gen.YangParser.Yin_element_stmtContext;
import org.onos.yangtools.yang.common.QName;
import org.onos.yangtools.yang.model.api.MustDefinition;
...
import org.onos.yangtools.yang.model.api.type.BitsTypeDefinition;
...
import org.onos.yangtools.yang.model.api.type.IntegerTypeDefinition;
...
import org.onos.yangtools.yang.model.util.BaseConstraints;
import org.onos.yangtools.yang.model.util.BaseTypes;
import org.onos.yangtools.yang.model.util.BinaryType;
import org.onos.yangtools.yang.model.util.BitImpl;
import org.onos.yangtools.yang.model.util.BitsType;
import org.onos.yangtools.yang.model.util.Decimal64;
...
import org.onos.yangtools.yang.model.util.Int16;
import org.onos.yangtools.yang.model.util.Int32;
import org.onos.yangtools.yang.model.util.Int64;
import org.onos.yangtools.yang.model.util.Int8;
import org.onos.yangtools.yang.model.util.Leafref;
import org.onos.yangtools.yang.model.util.MustDefinitionImpl;
import org.onos.yangtools.yang.model.util.RevisionAwareXPathImpl;
import org.onos.yangtools.yang.model.util.StringType;
import org.onos.yangtools.yang.model.util.Uint16;
import org.onos.yangtools.yang.model.util.Uint32;
import org.onos.yangtools.yang.model.util.Uint64;
import org.onos.yangtools.yang.model.util.Uint8;
import org.onos.yangtools.yang.parser.builder.api.Builder;
import org.onos.yangtools.yang.parser.builder.api.ConstraintsBuilder;
import org.onos.yangtools.yang.parser.builder.api.DataSchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.api.RefineBuilder;
import org.onos.yangtools.yang.parser.builder.api.SchemaNodeBuilder;
import org.onos.yangtools.yang.parser.builder.api.TypeAwareBuilder;
import org.onos.yangtools.yang.parser.builder.api.TypeDefinitionBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ChoiceCaseBuilder;
import org.onos.yangtools.yang.parser.builder.impl.ModuleBuilder;
import org.onos.yangtools.yang.parser.builder.impl.RefineHolderImpl;
import org.onos.yangtools.yang.parser.builder.impl.TypeDefinitionBuilderImpl;
import org.onos.yangtools.yang.parser.builder.impl.UnionTypeBuilder;
import org.onos.yangtools.yang.parser.util.TypeConstraints;
import org.onos.yangtools.yang.parser.util.UnknownBoundaryNumber;
import org.onos.yangtools.yang.parser.util.YangParseException;
