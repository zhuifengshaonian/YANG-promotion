...
import org.onos.yangtools.yang.parser.builder.util.AbstractBuilder;
...
public final class RefineHolderImpl extends AbstractBuilder implements RefineBuilder {
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#getDescription()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setDescription(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#getReference()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setReference(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#isConfiguration()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setConfiguration(java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#isMandatory()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setMandatory(java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#isPresence()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setPresence(java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#getMust()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setMust(org.onos.yangtools.yang.model.api.MustDefinition)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#getMinElements()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setMinElements(java.lang.Integer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#getMaxElements()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.onos.yangtools.yang.parser.builder.impl.IRefineBuilder#setMaxElements(java.lang.Integer)
     */
    @Override
