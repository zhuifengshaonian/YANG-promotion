...
import org.onos.yangtools.sal.binding.generator.impl.GeneratedClassLoadingStrategy;
import org.onos.yangtools.sal.binding.generator.impl.ModuleInfoBackedContext;
import org.onos.yangtools.yang.binding.YangModelBindingProvider;
...
public class ModelDiscoveryTest {
    ...
    public static final YangModuleInfo TOPOLOGY_OLD_MODULE = org.onos.yang.gen.v1.urn.tbd.params.xml.ns.yang.network.topology.rev130712.$YangModuleInfoImpl
            .getInstance();
    public static final YangModuleInfo TOPOLOGY_NEW_MODULE = org.onos.yang.gen.v1.urn.tbd.params.xml.ns.yang.network.topology.rev131021.$YangModuleInfoImpl
            .getInstance();
