...
public final class MapAdaptor {
    ...
    public static final String COPY_MAX_ITEMS_MAX_PROP = "org.onos.yangtools.util.mapadaptor.maxcopy";

    public static final int DEFAULT_PERSIST_MIN_ITEMS = 50;
    public static final String PERSIST_MIN_ITEMS_PROP = "org.onos.yangtools.util.mapadaptor.minpersist";
