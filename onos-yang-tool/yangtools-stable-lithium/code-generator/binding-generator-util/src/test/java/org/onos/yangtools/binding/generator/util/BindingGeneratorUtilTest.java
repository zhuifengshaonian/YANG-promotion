 ...
 */
package org.onos.yangtools.binding.generator.util;
...
import org.onos.yangtools.yang.model.util.ExtendedType.Builder;
...
public class BindingGeneratorUtilTest {
    ...
    public void testBindingGeneratorUtilMethods() throws IOException {
        ...
        assertEquals("Generated package name is incorrect.",
                "org.onos.yang.gen.v1.urn.m.o.d.u.l.e.n.a.m.e.t.e.s.t._case._1digit.rev130910", packageName);
        ...
        assertEquals("The name of the subpackage is incorrect.",
                "org.onos.yang.gen.v1.urn.m.o.d.u.l.e.n.a.m.e.t.e.s.t._case._1digit.rev130910.cont.outter",
        ...
        assertEquals("The name of the subpackage is incorrect.",
                "org.onos.yang.gen.v1.urn.m.o.d.u.l.e.n.a.m.e.t.e.s.t._case._1digit.rev130910",
        ...
        GeneratedTypeBuilder genTypeBuilder = new GeneratedTypeBuilderImpl("org.onos.yangtools.test", "TestType");
        genTypeBuilder.addMethod("testMethod");
        genTypeBuilder.addAnnotation("org.onos.yangtools.test.annotation", "AnnotationTest");
        genTypeBuilder.addEnclosingTransferObject("testObject");
        genTypeBuilder.addProperty("newProp");
        GeneratedTypeBuilder genType = new GeneratedTypeBuilderImpl("org.onos.yangtools.test", "Type2");
        genTypeBuilder.addImplementsType(genType);
        long computedSUID = BindingGeneratorUtil.computeDefaultSUID(genTypeBuilder);

        GeneratedTypeBuilder genTypeBuilder2 = new GeneratedTypeBuilderImpl("org.onos.yangtools.test2", "TestType2");
