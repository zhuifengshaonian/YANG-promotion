...
public class AbstractTypeMemberTest {
    ...
    public void testMethodsForAbstractTypeMemberBuilder() {
        ...
        final GeneratedTypeBuilderImpl typeBuilderImpl = new GeneratedTypeBuilderImpl("org.onos.yangtools.test", "TestType");
        final GeneratedTypeBuilderImpl typeBuilderImpl2 = new GeneratedTypeBuilderImpl("org.onos.yangtools.test", "TestType2");
        ...
        assertTrue(genProperty.toString().contains("org.onos.yangtools.test.TestType"));
