...
public class ConstantImplTest {
    ...
    public void testMethodsOfConstantImpl() {
        final GeneratedTypeBuilderImpl definingType = new GeneratedTypeBuilderImpl("org.onos.yangtools.test",
                "DefiningType");
        final GeneratedTypeBuilderImpl type = new GeneratedTypeBuilderImpl("org.onos.yangtools.test.v1",
                "BaseType");
