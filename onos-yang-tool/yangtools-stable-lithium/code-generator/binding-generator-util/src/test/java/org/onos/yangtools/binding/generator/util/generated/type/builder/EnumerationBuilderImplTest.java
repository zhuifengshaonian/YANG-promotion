...
public class EnumerationBuilderImplTest {
    ...
    private final String packageName = "org.onos.test";
    ...
    public void setup() {
        ...
        enumerationBuilderOtherPackage = new EnumerationBuilderImpl("org.onos.other", name);
    ...
    public void testEnumerationToString() {
        ...
        assertEquals("EnumerationBuilderImpl " +
                "[packageName=org.onos.test, name=TestName, " +
                "values=[EnumPair [name=TestValue, value=12]]]",
