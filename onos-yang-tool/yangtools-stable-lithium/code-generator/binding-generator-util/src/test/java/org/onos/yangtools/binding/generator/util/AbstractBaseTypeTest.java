...
public class AbstractBaseTypeTest {
    ...
    public void testCreateAbstractBaseTypeWithNullTypeName() {
        ...
        new AbstractBaseType("org.onos.yangtools.test", null);
    }

    @Test
    public void testHashCode() {
        AbstractBaseType baseType1 = new AbstractBaseType("org.onos.yangtools.test", "Test");
        AbstractBaseType baseType2 = new AbstractBaseType("org.onos.yangtools.test", "Test2");
        assertNotEquals(baseType1.hashCode(), baseType2.hashCode());
    }

    @Test
    public void testToString() {
        AbstractBaseType baseType = new AbstractBaseType("org.onos.yangtools.test", "Test");
        assertTrue(baseType.toString().contains("org.onos.yangtools.test.Test"));
    ...
    public void testEquals() {
        ...
        AbstractBaseType baseType4 = new AbstractBaseType("org.onos.yangtools.test", "Test");
        AbstractBaseType baseType5 = new AbstractBaseType("org.onos.yangtools.test1", "Test");
