...
public class TypeProviderIntegrationTest {
    private final String PKG = "org.onos.yang.gen.v1.urn.onos.test.rev131008.";
    ...
    public void testGetTypeDefaultConstructionEnumeration() throws ParseException {
        ...
        String actual = provider.getTypeDefaultConstruction(leaf);
        assertEquals("org.onos.yang.gen.v1.urn.onos.test.rev131008.LeafEnumeration.Seven", actual);
    ...
    public void testGetTypeDefaultConstruction() throws ParseException {
        ...
        String actual = provider.getTypeDefaultConstruction(leaf);
        String exp = "new org.onos.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev100924.Ipv4Address(\"0.0.0.1\")";
