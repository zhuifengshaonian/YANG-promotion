...
import static org.onos.yangtools.binding.generator.util.BindingGeneratorUtil.computeDefaultSUID;
import static org.onos.yangtools.binding.generator.util.BindingGeneratorUtil.packageNameForGeneratedType;
import static org.onos.yangtools.binding.generator.util.BindingTypes.DATA_OBJECT;
import static org.onos.yangtools.binding.generator.util.BindingTypes.DATA_ROOT;
import static org.onos.yangtools.binding.generator.util.BindingTypes.IDENTIFIABLE;
import static org.onos.yangtools.binding.generator.util.BindingTypes.IDENTIFIER;
import static org.onos.yangtools.binding.generator.util.BindingTypes.NOTIFICATION;
import static org.onos.yangtools.binding.generator.util.BindingTypes.augmentable;
import static org.onos.yangtools.binding.generator.util.Types.BOOLEAN;
import static org.onos.yangtools.binding.generator.util.Types.FUTURE;
import static org.onos.yangtools.binding.generator.util.Types.VOID;
import static org.onos.yangtools.binding.generator.util.Types.typeForClass;
import static org.onos.yangtools.yang.model.util.SchemaContextUtil.findDataSchemaNode;
import static org.onos.yangtools.yang.model.util.SchemaContextUtil.findNodeInSchemaContext;
import static org.onos.yangtools.yang.model.util.SchemaContextUtil.findParentModule;
...
import org.onos.yangtools.sal.binding.generator.impl.YangTemplate;
import org.onos.yangtools.binding.generator.util.BindingGeneratorUtil;
import org.onos.yangtools.binding.generator.util.BindingTypes;
...
import org.onos.yangtools.binding.generator.util.generated.type.builder.GeneratedPropertyBuilderImpl;
import org.onos.yangtools.binding.generator.util.generated.type.builder.GeneratedTOBuilderImpl;
import org.onos.yangtools.binding.generator.util.generated.type.builder.GeneratedTypeBuilderImpl;
...
import org.onos.yangtools.sal.binding.model.api.GeneratedTransferObject;
import org.onos.yangtools.sal.binding.model.api.GeneratedType;
import org.onos.yangtools.sal.binding.model.api.ParameterizedType;
import org.onos.yangtools.sal.binding.model.api.Restrictions;
...
import org.onos.yangtools.sal.binding.yang.types.GroupingDefinitionDependencySort;
import org.onos.yangtools.sal.binding.yang.types.TypeProviderImpl;
...
import org.onos.yangtools.yang.binding.annotations.RoutingContext;
...
import org.onos.yangtools.yang.model.util.DataNodeIterator;
import org.onos.yangtools.yang.model.util.SchemaContextUtil;
import org.onos.yangtools.yang.model.util.SchemaNodeUtils;
import org.onos.yangtools.yang.model.util.UnionType;
import org.onos.yangtools.yang.parser.builder.util.Comparators;
import org.onos.yangtools.yang.parser.util.ModuleDependencySort;
...
public class BindingGeneratorImpl implements BindingGenerator {
     ...
     */
    private static final String YANG_EXT_NAMESPACE = "urn:onos:yang:extension:yang-ext";
     ...
     * class {@link org.onos.yangtools.yang.model.api.BaseIdentity
     ...
     * {@link org.onos.yangtools.yang.binding.DataObject DataObject}.<br>
     * If <code>schemaNode</code> is instance of GroupingDefinition it also
     * implements {@link org.onos.yangtools.yang.binding.Augmentable
     * Augmentable}.<br>
     * If <code>schemaNode</code> is instance of
     * {@link org.onos.yangtools.yang.model.api.DataNodeContainer
     ...
     * {@link org.onos.yangtools.yang.model.util.UnionType UnionType} or
     * {@link org.onos.yangtools.yang.model.api.type.BitsTypeDefinition
