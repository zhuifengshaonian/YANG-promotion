...
public class DefaultSourceCodeGenerator implements SourceCodeGenerator {
    ...
    private static final String GENERATED_SOURCE_DIR_PROP = "org.onos.yangtools.sal.generatedCodecSourceDir";
     ...
     *     is obtained from a system property (<i>org.onos.yangtools.sal.generatedCodecSourceDir</i>) or
