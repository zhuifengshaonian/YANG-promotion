...
public class GeneratorJavaFileTest {
    ...
    public void test() throws IOException {
        ...
        GeneratedType t1 = createGeneratedType("org.onos.controller.gen", "Type1");
        GeneratedType t2 = createGeneratedType("org.onos.controller.gen", "Type2");
        GeneratedType t3 = createGeneratedType("org.onos.controller.gen", "Type3");
        types.add(t1);
        types.add(t2);
        types.add(t3);
        GeneratedTypeBuilder gtb = new GeneratedTypeBuilderImpl("org.onos.controller.gen", "Type4");
        ...
        String[] files = new File(PATH + FS + "org" + FS + "onos" + FS + "controller" + FS + "gen").list();
