...
public class CascadeUsesCompilationTest extends BaseCompilationTest {
    ...
    public void testCascadeUsesCompilation() throws Exception {
        ...
        Class<?> nodesClass = Class.forName(BASE_PKG + ".urn.onos.foo.rev131008.Nodes", true,
                loader);
        Class<?> nodesBuilderClass = Class.forName(BASE_PKG + ".urn.onos.foo.rev131008.NodesBuilder", true,
                loader);
        Class<?> fooGr1Class = Class.forName(BASE_PKG + ".urn.onos.foo.rev131008.FooGr1", true, loader);
        Class<?> barGr2Class = Class.forName(BASE_PKG + ".urn.onos.bar.rev131008.BarGr2", true, loader);
        Class<?> barGr1Class = Class.forName(BASE_PKG + ".urn.onos.bar.rev131008.BarGr1", true, loader);
        Class<?> bazGr1Class = Class.forName(BASE_PKG + ".urn.onos.baz.rev131008.BazGr1", true, loader);
