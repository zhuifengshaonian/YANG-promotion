...
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.NS_TEST;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsConstructor;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsField;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsMethod;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsRestrictionCheck;
...
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertImplementsParameterizedIfc;
...
public class CompilationTest extends BaseCompilationTest {
    ...
    public void testListGeneration() throws Exception {
        ...
        final Class<?> keyArgsClass = Class.forName(BASE_PKG + ".urn.onos.test.rev131008.KeyArgs", true, loader);
        final Class<?> linksClass = Class.forName(BASE_PKG + ".urn.onos.test.rev131008.Links", true, loader);
        final Class<?> linksKeyClass = Class.forName(BASE_PKG + ".urn.onos.test.rev131008.LinksKey", true, loader);
    ...
    public void testLeafReturnTypes() throws Exception {
        ...
        final String pkg = BASE_PKG + ".urn.onos.test.rev131008";
        final ClassLoader loader = new URLClassLoader(new URL[] { compiledOutputDir.toURI().toURL() });
    ...
    public void testGenerationContextReferenceExtension() throws Exception {
        ...
        final ClassLoader loader = new URLClassLoader(new URL[] { compiledOutputDir.toURI().toURL() });
        final Class<?> nodesClass = Class.forName(BASE_PKG + ".urn.onos.foo.rev131008.Nodes", true, loader);
        final Class<?> identityClass = Class
                .forName(BASE_PKG + ".urn.onos.bar.rev131008.IdentityClass", true, loader);

        // test identity
        try {
            identityClass.getConstructor();
            final Class<?> baseIdentity = Class.forName("org.onos.yangtools.yang.binding.BaseIdentity", true, loader);
    ...
    private static void testReturnTypeInstanceIdentitifer(final ClassLoader loader, final Class<?> clazz, final String methodName)
        ...
        try {
            method = clazz.getMethod(methodName);
            rawReturnType = Class.forName("org.onos.yangtools.yang.binding.InstanceIdentifier", true, loader);
