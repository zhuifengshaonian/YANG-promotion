...
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsDefaultMethods;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsField;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsFieldWithValue;
import static org.onos.yangtools.sal.java.api.generator.test.CompilationTestUtils.assertContainsGetLengthOrRange;
...
public class TypedefCompilationTest extends BaseCompilationTest {
    ...
    public void test() throws Exception {
        ...
        String pkg = BASE_PKG + ".urn.onos.foo.rev131008";
