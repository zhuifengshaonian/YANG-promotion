...
public class UnionTypedefUnusedImportTest extends BaseCompilationTest {
    ...
    public void testUnionTypedefUnusedImport() throws Exception {
        ...
        final boolean isUsedImport = containsImport("org.onos.yang.gen.v1.org.onos.yangtools.union.typedef.rev130208.TypedefUnion");
    ...
    private static boolean containsImport(final String fullImport) throws URISyntaxException, IOException {
        final String filePath = GENERATOR_OUTPUT_PATH + FS + "union-typedef" + FS + "org" + FS + "onos" + FS + "yang" + FS + "gen" + FS + "v1" + FS + "org" + FS + "onos" + FS + "yangtools" + FS + "union" + FS + "typedef" + FS + "rev141124" + FS + "TypedefUnionBuilder.java";
