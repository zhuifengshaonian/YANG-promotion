...
public class NestedGroupingCompilationTest extends BaseCompilationTest {
    ...
    public void testListGeneration() throws Exception {
        ...
        Class<?> fooClass = Class.forName(BASE_PKG + ".urn.onos.test.rev131008.Foo", true, loader);
        Class<?> barClass = Class.forName(BASE_PKG + ".urn.onos.test.rev131008.foo.Bar", true, loader);
