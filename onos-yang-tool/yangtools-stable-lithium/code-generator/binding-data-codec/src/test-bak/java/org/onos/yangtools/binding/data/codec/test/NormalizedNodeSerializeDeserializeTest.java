...
import static org.onos.controller.md.sal.test.model.util.ListsBindingUtils.top;
import static org.onos.controller.md.sal.test.model.util.ListsBindingUtils.topLevelList;
import static org.onos.yangtools.yang.data.impl.schema.Builders.*;
import static org.onos.yangtools.yang.data.impl.schema.ImmutableNodes.leafNode;
import static org.onos.yangtools.yang.data.impl.schema.ImmutableNodes.mapEntry;
import static org.onos.yangtools.yang.data.impl.schema.ImmutableNodes.mapEntryBuilder;
import static org.onos.yangtools.yang.data.impl.schema.ImmutableNodes.mapNodeBuilder;
...
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.TopChoiceAugment1;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.TopChoiceAugment1Builder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.TopChoiceAugment2;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.TopChoiceAugment2Builder;
...
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.TreeLeafOnlyAugmentBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.top.augment.choice1.Case1Builder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.top.augment.choice1.case1.augment.choice2.Case11Builder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.augment.rev140709.top.augment.choice1.case1.augment.choice2.case11.Case11ChoiceCaseContainerBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.ChoiceContainer;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.ChoiceContainerBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.Top;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.TopBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.choice.identifier.ExtendedBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.choice.identifier.extended.ExtendedIdBuilder;
...
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.two.level.list.top.level.list.NestedList;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.two.level.list.top.level.list.NestedListBuilder;
import org.onos.yang.gen.v1.urn.onos.params.xml.ns.yang.yangtools.test.binding.rev140701.two.level.list.top.level.list.NestedListKey;
...
public class NormalizedNodeSerializeDeserializeTest extends AbstractBindingRuntimeTest{
    ...
    public static final QName TOP_QNAME =
            QName.create("urn:onos:params:xml:ns:yang:yangtools:test:binding", "2014-07-01", "top");
    ...
    public static final QName CHOICE_CONTAINER_QNAME =
            QName.create("urn:onos:params:xml:ns:yang:yangtools:test:binding", "2014-07-01", "choice-container");
    ...
    public void augmentMultipleChoices() {
        QName augmentChoice1QName = QName.create("urn:onos:params:xml:ns:yang:yangtools:test:augment",
