...
final class CaseNodeCodecContext<D extends DataObject> extends DataObjectCodecContext<D,ChoiceCaseNode> {
    ...
    protected void addYangPathArgument(final PathArgument arg,
            final List<org.onos.yangtools.yang.data.api.YangInstanceIdentifier.PathArgument> builder) {
        // NOOP
    }
    ...
    @Override
    public org.onos.yangtools.yang.data.api.YangInstanceIdentifier.PathArgument serializePathArgument(
            PathArgument arg) {
    ...
    public PathArgument deserializePathArgument(
            org.onos.yangtools.yang.data.api.YangInstanceIdentifier.PathArgument arg) {
        Preconditions.checkArgument(arg == null);
        return null;
    }
}