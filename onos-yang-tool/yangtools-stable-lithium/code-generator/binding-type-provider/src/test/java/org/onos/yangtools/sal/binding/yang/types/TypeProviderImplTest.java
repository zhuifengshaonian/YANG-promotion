...
import org.onos.yangtools.yang.model.util.BooleanType;
import org.onos.yangtools.yang.model.util.Decimal64;
import org.onos.yangtools.yang.model.util.EmptyType;
...
public class TypeProviderImplTest {
    ...
    public void testMethodsOfTypeProviderImpl() throws URISyntaxException {
        ...
        final GeneratedTypeBuilderImpl refType = new GeneratedTypeBuilderImpl("org.onos.yangtools.test", "TestType");
