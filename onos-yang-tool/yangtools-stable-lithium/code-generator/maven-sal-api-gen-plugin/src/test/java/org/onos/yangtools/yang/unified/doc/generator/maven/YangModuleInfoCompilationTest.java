 ...
 */
package org.onos.yangtools.yang.unified.doc.generator.maven;
...
import org.onos.yangtools.maven.sal.api.gen.plugin.CodeGeneratorImpl;
...
public class YangModuleInfoCompilationTest {
    ...
    private static final String BASE_PKG = "org.onos.yang.gen.v1";
    ...
    public void compilationTest() throws Exception {
        ...
        final String BASE_PATH = "org" + FS + "onos" + FS + "yang" + FS + "gen" + FS + "v1";
